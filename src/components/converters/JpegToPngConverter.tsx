...
function JpegToPngConverter({ config }: ConverterComponentProps): React.ReactElement {
  const convertFile = useCallback(async (file: File): Promise<Blob> => convertImage(file, "png"), []);
